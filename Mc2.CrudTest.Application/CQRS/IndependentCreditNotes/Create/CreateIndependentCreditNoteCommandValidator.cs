...
{
    public class CreateIndependentCreditNoteCommandValidator : AbstractValidator<CreateIndependentCreditNoteCommand>
    {
        public CreateIndependentCreditNoteCommandValidator()
        {
            ...
            RuleFor(c => c.IndependentCreditNoteInPutDto.ExternalCreditNumber).Length(10).WithMessage("ExternalCreditNumber includes 10 characters.");
